        ...
        <Carousel className="custom-carousel">
          <Carousel.Item>
            <img
              ...
              src="https://media.geeksforgeeks.org/wp-content/uploads/20240105125520/1st.jpg"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="d-block w-100 carousel-image"
              src="https://media.geeksforgeeks.org/wp-content/uploads/20240105125527/2nd.jpg"
              alt="Second slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="d-block w-100 carousel-image"
              src="https://media.geeksforgeeks.org/wp-content/uploads/20240105125534/3rd.jpg"
              alt="Third slide"
            />
          </Carousel.Item>
          <Carousel.Item>
